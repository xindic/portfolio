export const About = () => {
  return (
    <div
      id="white"
      className="h-[110vh] w-auto bg-[#FAFAF9] flex flex-col items-top justify-center space-y-10"
    >
      ...
      <div className="h-screen w-auto flex flex-row justify-center items-top">
        <div className="h-[80vh] w-[30vw] rounded-xl overflow-hidden">
          <img
            alt="About Me"
        ...
        <div className="h-[38vh] w-[40vw] ml-[2vw] flex flex-col items-start sticky top-[5vh]">
          <h5
            id="black"
          ...
          <p id="black" className="font-generalsans-medium text-left">
            ...
            easily interpret my thoughts. My modular approach makes it easy to
            add new features or make changes without disrupting the entire
            workflow. Common frameworks I use include Knit and Rojo.
          </p>
          <br></br>
          <p id="black" className="font-generalsans-medium text-left">
